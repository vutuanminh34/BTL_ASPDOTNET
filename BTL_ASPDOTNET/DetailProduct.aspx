<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd.Master" AutoEventWireup="true" CodeBehind="DetailProduct.aspx.cs" Inherits="BTL_ASPDOTNET.DetailProduct" %>
...
<td class="title_page" valign="middle">
    <asp:Literal ID="LiteralCategoryName" runat="server" Text='<%# Eval("Category_name") %>' />
</td>
</tr>
</table>
        ...
        <table width="100%" border="0">
          ...
          <tr>
           ...
           <tr>
                    <td height="17" align="center" valign="bottom" class="gia">
                        ...
                        <asp:Button ID="btnDatHang" runat="server" BackColor="#666666" CommandArgument='<%# Eval("Product_id") %>' CommandName="AddToCart" Height="22px" style="color: #FFCC00" Text="Đặt hàng" Width="72px" />
                    </td>
                  </tr>
          ...
          <tr>
            <td align="center" class="text_def" height="17">
                Còn lại
                <asp:Literal ID="Literal8" runat="server" Text='<%# Eval("Product_quantity") %>' />
                sản phẩm</td>
          </tr>
        </table>
